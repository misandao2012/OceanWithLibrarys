package jian.zhang.oceanwithlibrarys.constants;
...
public class IntentExtra {
    ...
    public static final String SHOW_STATION_SUBTITLE = "SHOW_STATION_SUBTITLE";
    public static final String FIRST_TIME_DATA_LOADED = "FIRST_TIME_DATA_LOADED";
}
